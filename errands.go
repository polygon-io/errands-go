...
func ( e *ErrandsAPI ) GetErrands() ( *ErrandsResponse, error ){
	res, err := e.get("/v1/errands/"); if err != nil {
...
func ( e *ErrandsAPI ) CreateErrand( errand *schemas.Errand ) ( *ErrandResponse, error ){
	errandBytes, err := errand.MarshalJSON(); if err != nil {
		return &ErrandResponse{}, err
	}
	resp, err := http.Post( e.EndpointURL + "/v1/errands/", "application/json", bytes.NewBuffer( errandBytes )); if err != nil {
		return &ErrandResponse{}, err
	}
...
func ( e *ErrandsAPI ) RequestErrandToProcess( topic string ) ( *ErrandResponse, error ){
	client := &http.Client{}
	req, err := http.NewRequest("POST", e.EndpointURL + "/v1/errands/process/" + topic, nil); if err != nil {
		return &ErrandResponse{}, err
	}
...
func ( e *ErrandsAPI ) FailErrand( errandId, reason string ) ( *ErrandResponse, error ){
	...
	failReqBytes, err := failReq.MarshalJSON(); if err != nil {
		return &ErrandResponse{}, err
	}
	client := &http.Client{}
	req, err := http.NewRequest("PUT", e.EndpointURL + "/v1/errand/" + errandId + "/failed", bytes.NewBuffer( failReqBytes )); if err != nil {
		return &ErrandResponse{}, err
	}
...
func ( e *ErrandsAPI ) CompleteErrand( errandId string, results map[string]interface{} ) ( *ErrandResponse, error ){
	...
	compReqBytes, err := compReq.MarshalJSON(); if err != nil {
		return &ErrandResponse{}, err
	}
	client := &http.Client{}
	req, err := http.NewRequest("PUT", e.EndpointURL + "/v1/errand/" + errandId + "/completed", bytes.NewBuffer( compReqBytes )); if err != nil {
		return &ErrandResponse{}, err
	}
	req.Header.Set("Content-Type", "application/json; charset=utf-8")
	resp, err := client.Do(req); if err != nil {
...
func ( e *ErrandsAPI ) DeleteErrand( errandId string ) ( *ErrandResponse, error ){
	client := &http.Client{}
	req, err := http.NewRequest("DELETE", e.EndpointURL + "/v1/errand/" + errandId, nil); if err != nil {
		return &ErrandResponse{}, err
	}
	resp, err := client.Do(req); if err != nil {
		return &ErrandResponse{}, err
...
func ( e *ErrandsAPI ) get( url string ) ( []byte, error ) {
	resp, err := http.Get( e.EndpointURL + url ); if err != nil {
		return nil, err
	}
	body, err := ioutil.ReadAll(resp.Body); if err != nil {
		return nil, err
